        ...
        <Container maxWidth={PAGE_CONTAINER_MAX_WIDTH}>
          <Box
            sx={{
              ...
              overflow: "hidden",
              minHeight: { xs: "auto", md: 220, lg: 280 },
            }}
          >
            <Box
              sx={{
                ...
                position: "relative",
                minHeight: { xs: 200, md: 240, lg: 260 },
                display: "flex",
                alignItems: "flex-end",
                overflow: "hidden",
              }}
            ...
            >
              ...
              <Button
                href="https://www.instagram.com/reel/DLW2J4TI8GA/?utm_source=ig_web_copy_link&igsh=MW5nNHo5d3V1MDN6NA%3D%3D"
                target="_blank"
        ...
        categories={[
          {
            ...
            title: "Frontend",
            items: [
              "Next.js framework for enhanced performance and SEOoptimization",
          ...
          },
          {
            ...
            items: [
              "Amazon ECS clusters for scalable architecture",
