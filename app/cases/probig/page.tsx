...
export default function ProbigCaseStudy() {
  ...
  const otherCases = [STRIDIST_CASE_STUDY, ERUDITION_CASE_STUDY];
  return (
    <Box>
      ...
      >
        ...
        >
          Probig is an application for a local running club Probig that makes
          athletes’ and coaches’ life a way more better, easier and efficient.
        </Typography>
      ...
      <TechnologyStack
        categories={[
          {
            icon: <CodeXml color="#E498B7" size={30} />,
            title: "Frontend",
            items: ["Probig-UI"],
          },
          {
            icon: <FolderCode color="#E498B7" size={30} />,
            title: "Backend",
            items: [
              "Probig API",
              ".NET (Clean architecture, CQRS + MediatR, Unit-tests, Open-api) ",
              "SQL database",
