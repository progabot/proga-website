...
export default function ContactInfo() {
  ...
  return (
    <Box
      sx={{ display: "flex", flexDirection: "column", gap: 6, height: "100%" }}
    >
      ...
      >
        <Box>
          ...
          <Typography variant="body1" sx={{ mb: 4, color: "text.secondary" }}>
            ...
            <br />
            You can book a meeting either in person at our office or online.
          </Typography>
          ...
          >
            ...
            <Typography variant="body1">
              Address: Shota Rustaveli St, 12, Lviv, Lviv Oblast, 79000
            </Typography>
          </Box>
        </Box>
