          ...
          <Grid size={{ xs: 12, md: 6 }} sx={{ px: { xs: 2, md: 0 } }}>
            <Box
              sx={(theme) => ({
                ...
                aspectRatio: "690 / 561",
                width: "100%",
                maxWidth: { xs: "none", sm: 500, md: 600, lg: 700, xl: 800 },
                top: { xs: 20, sm: 40, md: 100 },
                color: "#fff",
                mb: { xs: 6, md: 10 },
                mr: { xs: -3, md: 0 },
            ...
            >
              ...
              <Box
                sx={{
                  ...
                  pt: { xs: 3, sm: 8, md: 4, lg: 4, xl: 10 },
                  pr: { xs: 8, sm: 10, md: 6, lg: 12, xl: 16 },
                  pb: { xs: 2, sm: 1, md: 2, lg: 2, xl: 2 },
                  pl: { xs: 4, sm: 8, md: 4, lg: 6, xl: 10 },
                  gap: { xs: 2, sm: 3 },
                }}
              >
                <Typography
